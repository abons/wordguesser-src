...
/**
 * Static list of 5-letter answer words. Kept in-app (no network, no assets file to
 * parse) so the game works fully offline and the APK stays tiny.
 *
 * This is also the dictionary used to validate guesses when the in-app "Strict mode"
 * setting is on (see MainActivity). With strict mode off, any 5-letter word is accepted.
 */
object WordBank {
    ...
    val ANSWERS: List<String> = listOf(
        ...
        "funny", "giant", "given", "glass", "globe", "going", "grace", "grade", "grain", "grand",
        "grant", "grass", "grave", "great", "green", "gross", "group", "grown", "guard", "guess",
        "guest", "guide", "happy", "harsh", "heart", "heavy", "hence", "horse", "hotel", "house",
